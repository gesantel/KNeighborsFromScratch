...
My helper function __check_x_ checks the number of axes of the input data. My fit function also checks there are as many samples/rows/data points as cluters. 

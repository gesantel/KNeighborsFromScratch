...
My helper function __check_x_ checks the number of axes of the input data. My _fit_ function also checks there are as many samples/rows/data points as cluters. 
